...
BIN = example-tour example-static example1 example2 example3 example4 example5 example6 sample_classification
OBJ = example-tour.o example-tour-s.o example1.o example2.o example3.o example4.o sample_classification.o\
...
sample_classification: sample_classification.o myio.o
	gcc sample_classification.o myio.o -o sample_classification  $(LDFLAGS) $(local_LDFLAGS)
